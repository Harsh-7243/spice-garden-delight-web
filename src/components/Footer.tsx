    ...
    <footer id="contact" className="bg-foreground text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* About Us */}
          <div>
            <h3 className="text-xl font-bold mb-4 font-playfair">About Us</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#story" className="text-white/80 hover:text-primary transition-colors">Our Story</a></li>
              <li><a href="#menu" className="text-white/80 hover:text-primary transition-colors">Menu</a></li>
              <li><a href="#legacy" className="text-white/80 hover:text-primary transition-colors">Legacy</a></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <p className="text-white/80">123 Spice Lane, Flavor District, Culinary City</p>
              </div>
              ...
              <div className="flex items-center">
                ...
                <p className="text-white/80">info@spicegarden.com</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="font-medium">Mon – Fri</h4>
                  <p className="text-white/80">10:00 AM – 10:00 PM</p>
                </div>
              </div>
              <div className="flex items-center">
                <Clock className="h-5 w-5 mr-3 text-primary shrink-0" />
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-white/80">12:00 PM – 9:00 PM</p>
                </div>
              </div>
            </div>
          </div>
